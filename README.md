...
This project Demonstrates a comprehensive data warehousing and analytics solutions, from building a data warehouse to generating actionable insights. Designed a portfolio project highlighting industry best practices in data engineering and analytics.
...
#### Specification
- **Data Sources**: Downloaded data from Online Platforms as CSV files.
